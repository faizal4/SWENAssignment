...
namespace HMSSystem
{
    public partial class RoomBooking : Form
    {
        ...
        {
            RBDate newDate = new RBDate();
            dateTimePicker1.Format = DateTimePickerFormat.Custom;
            dateTimePicker1.CustomFormat = "yyyy-MM-dd";
            newDate.StartDate = "'" + dateTimePicker1.Value.ToShortDateString() + "'";
            dataGridView1.DataSource = RBDatabase.GetAllBooking(newDate);
        }
        private void dateTimePicker1_ValueChanged(object sender, EventArgs e)
        {
            HKDate newDate = new HKDate();
            dateTimePicker1.Format = DateTimePickerFormat.Custom;
            dateTimePicker1.CustomFormat = "yyyy-MM-dd";
            newDate.StartDate = "'" + dateTimePicker1.Value.ToShortDateString() + "'";
        }
        ...
        private void btnExportExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                wb.Worksheets.Add(dt, "Booking");
                wb.SaveAs(folderPath + "RoomBookingExport.xlsx");
            }
        }
