...
namespace HMSSystem
{
    public partial class RoomOccupant : Form
    {
        public RoomOccupant()
        {
            InitializeComponent();
        ...
        {
            dataGridView1.DataSource = ROTDatabase.GetRoomOccupant();
        } 
        Bitmap bitmap;
        ...
        private void btnExportExcel_Click_1(object sender, EventArgs e)
        {
            ...
            {
                wb.Worksheets.Add(dt, "Occupants");
                wb.SaveAs(folderPath + "RoomOccupantExport.xlsx");
            }
        }
